<x-app-layout>
    ...
    <div class="md:py-12 md:mx-20 bg-green-500 border-4 border-blue-500 rounded-md">
    <table class="md:flex justify-center">
        ...
        <tr>
            ...
            <td class="block mt-4 mx-7 w-full">:</td>
            <td><div class="overflow-auto bg-white block mt-3 w-full border-green-500 rounded-md" type="text" name="status" value="" readonly>{{$documents->bidang->bidang}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="block mt-3 mx-7 w-full">:</td>
            <td><input type="text" id="keterangan" class="block w-full border-green-500 rounded-md" type="text" name="keterangan" value="{{$documents->keterangan}}" readonly></td>
        </tr>
